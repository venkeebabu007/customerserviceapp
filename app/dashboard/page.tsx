  ...
  return (
    <div className="space-y-6 w-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <DashboardCard title="Open Tickets" count={openTickets} link="/tickets?status=open" />
        <DashboardCard title="In Progress" count={inProgressTickets} link="/tickets?status=in-progress" />
        <DashboardCard title="Resolved Tickets" count={resolvedTickets} link="/tickets?status=resolved" />
      </div>
